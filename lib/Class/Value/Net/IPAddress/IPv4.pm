...
=head1 SYNOPSIS
    ...
    Class::Value::Net::IPAddress::IPv4->new;
...
Class::Value::Net::IPAddress::IPv4 inherits from
L<Class::Value::Net::IPAddress>.

The superclass L<Class::Value::Net::IPAddress> defines these methods and
functions:

    clear_forbid_internal(), dns_rr_type(), forbid_internal(),
    forbid_internal_clear(), forbid_internal_set(), is_internal(),
    semantic_args(), send_notify_value_invalid(),
    send_notify_value_not_wellformed(), set_forbid_internal()
