...
# $Id: Preference.pm 11149 2006-04-18 16:28:08Z ek $
...
=head1 SYNOPSIS
    ...
    Class::Value::Net::NAPTR::Preference->new;
...
Class::Value::Net::NAPTR::Preference inherits from
L<Class::Value::Net::NAPTR::UInt16>.

The superclass L<Class::Value::Net::NAPTR::UInt16> defines these methods
and functions:
