...
Class::Value::Net::NAPTR::Origin - network-related value objects

=head1 SYNOPSIS

    Class::Value::Net::NAPTR::Origin->new;
...
Class::Value::Net::NAPTR::Origin inherits from L<Class::Value::Boolean>.
