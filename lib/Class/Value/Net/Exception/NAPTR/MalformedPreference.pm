...
# $Id: MalformedPreference.pm 11166 2006-04-19 11:31:26Z gr $
...
use constant default_message => 'Malformed Preference [%s]';
...
Class::Value::Net::Exception::NAPTR::MalformedPreference - network-related value objects

=head1 SYNOPSIS

    Class::Value::Net::Exception::NAPTR::MalformedPreference->new;
...
Class::Value::Net::Exception::NAPTR::MalformedPreference inherits from
L<Class::Value::Net::Exception::NAPTR>.

The superclass L<Class::Value::Net::Exception::NAPTR> defines these methods
and functions:

    clear_recordfield(), recordfield(), recordfield_clear()
