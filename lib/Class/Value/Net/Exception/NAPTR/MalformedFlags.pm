...
# $Id: MalformedFlags.pm 11166 2006-04-19 11:31:26Z gr $
...
=head1 SYNOPSIS
    ...
    Class::Value::Net::Exception::NAPTR::MalformedFlags->new;
...
Class::Value::Net::Exception::NAPTR::MalformedFlags inherits from
