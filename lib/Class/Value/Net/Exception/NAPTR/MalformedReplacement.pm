...
# $Id: MalformedReplacement.pm 11166 2006-04-19 11:31:26Z gr $
...
=head1 SYNOPSIS
    ...
    Class::Value::Net::Exception::NAPTR::MalformedReplacement->new;
...
Class::Value::Net::Exception::NAPTR::MalformedReplacement inherits from
