...
# $Id: InvalidIPAddress.pm 13653 2007-10-22 09:11:20Z gr $
...
Class::Value::Net::Exception::InvalidIPAddress - network-related value objects

=head1 SYNOPSIS

    Class::Value::Net::Exception::InvalidIPAddress->new;
...
Class::Value::Net::Exception::InvalidIPAddress inherits from
L<Class::Value::Net::Exception>.
